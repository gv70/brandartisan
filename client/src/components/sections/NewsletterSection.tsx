      ...
      <div className="max-w-4xl mx-auto text-center">
        <ScrollReveal>
          <div className="fade-scale animate">
            <h2 className="font-serif text-4xl md:text-5xl font-semibold text-cream mb-6" data-testid="text-newsletter-title">
              Unisciti al mondo Mathilde
            </h2>
            <p className="text-xl text-cream/80 mb-12 max-w-2xl mx-auto" data-testid="text-newsletter-subtitle">
