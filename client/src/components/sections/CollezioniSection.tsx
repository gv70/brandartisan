...
export default function CollezioniSection({ onCollezioneClick }: CollezioniSectionProps) {
  return (
    <section id="collezioni" className="py-16 sm:py-20 lg:section-spacing px-4 sm:px-6 lg:container-spacing bg-warm-beige">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 sm:gap-12 lg:gap-16 items-center">
          ...
          <ScrollReveal delay={400}>
            <div>
              <h3 className="font-serif text-2xl lg:text-3xl font-semibold text-text-primary mb-6" data-testid="text-collezione-season">
